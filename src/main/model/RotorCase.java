...
public class RotorCase {
    ...
    private static final ArrayList<Integer> rotor1Out = new ArrayList(Arrays.asList(4, 8, 9, 2, 6, 1, -3, 8, 13, 16,
    ...
    private static final ArrayList<Integer> rotor1Return = new ArrayList(Arrays.asList(20, 21, 22, 3, -4, -2, -1, 8,
            13, 16, -8, -6, -9, -3, -2, 4, -8, 6, 0, -8, -3, -13, -9, -7, -10, -16));

    private static final ArrayList<Integer> rotor2Out = new ArrayList(Arrays.asList(0, 9, 1, 7, 14, 3, 11, 13, 15, -8,
    ...
    private static final ArrayList<Integer> rotor2Return = new ArrayList(Arrays.asList(0, 8, 13, -1, 21, 17, 11, 4, -3,
            -9, -7, -1, 2, 6, 10, 5, 0, -11, -14, -6, -13, 2, -10, -15, -3, -7));
